    ...
    <Card className="glass-card bg-gray-900/95 border-gray-800">
      <CardHeader className="pb-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-sm bg-gray-800/50 p-3 rounded-lg">
          ...
          <div>
            ...
            <p className="text-white font-medium">{volume24h.toLocaleString(undefined, { maximumFractionDigits: 0 })}</p>
          </div>
          <div>
      ...
      <CardContent className="p-0">
        ...
        <div className="h-[500px] w-full bg-gray-900 relative">
          ...
          {activeTrade && (
            <div className="absolute top-4 left-4 bg-gray-900/90 backdrop-blur-sm p-3 rounded-lg border border-gray-700">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                {activeTrade.target_price && (
                  <div>
                    ...
                    <span className={`ml-1 font-medium ${
                      activeTrade.direction === 'LONG' ? 'text-green-400' : 'text-red-400'
                    }`}>
                ...
                <div>
                  <Badge 
                    variant={activeTrade.direction === 'LONG' ? 'default' : 'destructive'}
                    className="text-xs"
                  >
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-gray-800/30 border-t border-gray-700">
          ...
          <div className="text-xs text-gray-400">
            Powered by Binance • Live Trading Data
          </div>
        </div>
      </CardContent>
    </Card>
