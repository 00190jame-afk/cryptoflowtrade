            ...
            <section className="prose prose-lg max-w-none dark:prose-invert">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p>Past performance is not an indicator of future performance. CryptoFlow does not in any way guarantee or provide any assurance about the performance or market price of Digital Assets or products available through the CryptoFlow Services.</p>
                  
                  <p>The Digital Asset industry is subject to systemic and systematic risk.</p>
                  ...
                  <p>These risks can affect the prices of Digital Assets.</p>
                ...
                <div>
                  ...
                  <p>Currency exchange fluctuations may impact your gains and losses.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-3">M. Legal and Regulatory Risks</h3>
                  <p>Most Digital Assets operate without a central authority and are generally not backed by any government or authority. Changes in laws and regulations may materially affect the value of Digital Assets. This risk is unpredictable and may vary from market to market.</p>
                  
                  <p>Further, Digital Assets may not be considered "property" under Applicable Laws in some jurisdictions. This may affect the nature and enforceability of your interest in the Digital Assets.</p>
                  
                  <p>Legislative and regulatory changes may adversely affect or restrict (as applicable) the use, transfer, exchange and value of Digital Assets, as well as the provision of the CryptoFlow Services in certain jurisdictions. Legislative and regulatory changes may occur quickly and without prior notice.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-3">N. Risk of trading using leverage</h3>
                  <p>Trading using leverage entails significant risk and it is important that you fully understand the risks involved in trading Digital Assets using leverage.</p>
                  
                  <p>A relatively small market movement will have a proportionately larger impact on the leveraged funds you have deposited or will have to deposit; this may work against you as well as for you. You may sustain a total loss of initial margin funds and, in exceptional circumstances, any additional funds deposited with CryptoFlow to maintain your position. If the market moves against your position or margin levels are increased, you may be called upon to pay substantial additional funds on short notice to maintain your position. If you fail to comply with a request for additional funds within the time prescribed, your position may be liquidated at a loss and you may, in exceptional circumstances, be liable for any resulting deficit.</p>
                </div>
                ...
                <div>
                  ...
                  <p>The risk of loss is substantial. In volatile market conditions, the price of Digital Assets, and therefore the price of Digital Asset Futures, may decline significantly in a short period of time, including to zero. An investor in Digital Asset Futures must be prepared and able to bear the loss of the entirety of their investment.</p>
                  
                  <p>You should not invest any amount that you cannot afford to lose. You are strongly encouraged to seek independent professional advice when deciding whether Digital Asset Futures products are suitable for you, having regard to your risk appetite, financial position and knowledge about Digital Assets.</p>
                  
                  <p>When trading Futures, it is your responsibility:</p>
                  ...
                  <p>When trading Futures you may suffer a loss as a result of a number of factors including but not limited to the following:</p>
